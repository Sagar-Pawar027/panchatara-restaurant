  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="hidden sm:inline">Indore Bypass • 100% Pure Veg Garden &amp; Poolside Sanctuary</span>
      ...
      >
        ...
        >
          <p className="leading-snug">A table.</p>
          <p className="leading-snug">A story.</p>
          <p className="leading-snug text-[#C5A880]">An experience.</p>
        </motion.div>
          ...
          <div className="bg-[#12110F]/85 border border-[#C5A880]/30 rounded-sm p-5 sm:p-7 backdrop-blur-md shadow-2xl relative">
            ...
            <div className="text-center mb-5 sm:mb-6">
              ...
              <h2 className="font-editorial-serif text-xl sm:text-2xl text-[#FAF7F2] font-light">
                How would you like to experience Panchtara?
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              ...
              >
                ...
                <div className="pt-4 flex items-center justify-between text-xs font-medium text-[#C5A880] border-t border-white/5 mt-4">
                  <span className="uppercase tracking-wider">Reserve a Table</span>
              ...
              >
                ...
                <div className="pt-4 flex items-center justify-between text-xs font-medium text-[#C5A880] border-t border-white/5 mt-4">
                  <span className="uppercase tracking-wider">Start Your Pre-Order</span>
                  <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1.5 transition-transform duration-300" />
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 pt-3 border-t border-white/10 text-center text-[11px] text-[#FAF7F2]/65 font-light">
              <span className="text-emerald-400 font-medium">Open Daily:</span> Lunch 11:00 AM – 3:30 PM • Dinner 6:30 PM – Midnight • Plan your visit
            </div>
          </div>
        </motion.div>
      </motion.div>
